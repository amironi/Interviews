...
/////////////mashine_state_olution//////////////
int calc2AL( int aN, int aL );

int calc1AL( int aN, int aL )
{
    if( aL == 0 )
    {
        return pow(3, aN);
    ...
    return pow( 3, aN ) +  // state A
    calc2AL( aN, aL - 1 ) + // state L
    calc2AL( aN, aL );// state O
}
...
int calc2AL( int aN, int aL )
{
    ...
    return calc1AL( aN, aL ) +   //state A
    calc2AL( aN, aL - 1 ) +  //state L
    calc2AL( aN, aL );// state O
}

int mashine_state_olution( int aN )
{
    return calc2AL( aN, 3 );
}
